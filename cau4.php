<script>
            ...
            $('#getdate').change(function(){
                ...
                $.post('lietkesachcuadg.php', { dropdownValue: inputValue }, function(data){
                    $("#ajaxngay").html(data);
...
<table >
    <tr>
      <td style="border:none;">Danh sách độc giả :  
        <?php
           include "connect.php";

            echo " <select id='getdate' name='getdate'><option  disabled selected>--Chọn độc giả--</option>"; 
